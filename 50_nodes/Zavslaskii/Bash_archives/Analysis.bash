...
gnuplot ./Analysis/Plot_Degree_vs_Similarity.gnu
#python ./Analysis/Peaks_several_nodes.py
#./Analysis/dibuix.bash
#python ./Analysis/Distance_Measure.py
#python ./Analysis/Histogram_2D_IPI.py
#python ./Analysis/Degree_vs_Maximal_Information_Transfer.py
#bash ./Analysis/Degree_vs_Similarity.bash
#python ./Analysis/Distance_between_histograms.py
...
#python ./Analysis/Regularity_List_Good.py
#python ./Analysis/Create_Regularity_Graph.py
#python ./Analysis/Regularity_ALL_AT_ONCE.py
...
#gnuplot./Analysis/Plot_Corr_vs_Pair.gnu
