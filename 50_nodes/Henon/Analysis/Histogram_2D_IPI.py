...
#Input_Attractor=np.loadtxt('./Output_No_Noise/Output_Clustering_0.0/Output_Time_Scale_1/Chen_rec.dat', unpack=True)
...
H, xedges, yedges = np.histogram2d(All_IPI_2,All_IPI_1, bins=(1000, 1000),normed=True)
...
plt.savefig('%s/Histogram_2D_%s_output.eps' %(path,att))
plt.close()
