...
for p in 155
	do
	for alpha in $(seq 01.00 01.00 01.00)
		do
		for beta in $(seq 01.00 01.00 01.00)
			do
			for ((SEED=1;SEED<=10;SEED++))
				...
				for Frequencia in 08.50
					...
					for Amplitud in 0
						...
						Poincare_Dat="Output/1_variable/${Attractor}/Output_${Num_seed}/Output_alpha_${Num_alpha}/Output_beta_${Num_beta}/Poincare_Section_tau_10_equal_${Num_sec}.dat"
